    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active">add new units</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content" style="margin-left: 400px;">
                ...
                <form action="../../../app/controllers/Units/UnitsController.php" method="POST">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="validationDefault01">Units</label>
                            <select name="names" class="custom-select">
                                <option selected></option>
                                <option value="0(kg)">Kg</option>
                                <option value="1(L)">L</option>
                                <option value="2(M)">M</option>
                                <option value="3(Cm)">Cm</option>
                                <option value="4(g)">g</option>
                            </select>
                        </div>
                    </div>
                    <input type="submit" name="kaydet" class="btn btn-lg btn-warning" value="Kaydet">
                </form>
            </section>
