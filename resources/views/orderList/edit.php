                ...
                <form method="POST" action="../../../app/controllers/product/ProductListController.php">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" value="<?= $guncelle[0]['names'] ?>" class="form-control" name="names" id="inputEmail4" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputPassword4">Piece</label>
                            <input type="number" value="<?= $guncelle[0]['piece'] ?>" class="form-control" name="piece" id="inputPassword4" required>
                        </div>
                    </div>
                    <input type="submit" class="btn btn-lg btn-primary" name="Edit" style="margin-left: 745px;" value="Edit">
